...
long stub___android_log_buf_write(void){ static int n=0; if(n++<2) fprintf(stderr,"[STUB] __android_log_buf_write\\n"); return 0; }
...
DynLibFunction dynlib_functions[] = {
  ...
  {"__android_log_buf_write", (uintptr_t)&stub___android_log_buf_write},
